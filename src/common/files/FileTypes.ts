...
export type SF_LexemeForm = Simplify<JTDDataType<typeof schema_LexemeForm>>

const schema_Lexeme = {
  properties: {
    lexemeId: schema_Uuid,
    entryForm: schema_LexemeForm,
  },
}
...
export type SaveFileLatest = JTDDataType<typeof schema_SaveFile>
export const schemaValidate_SaveFileLatest = ajv.compile<SaveFile>(schema_SaveFile_Latest)
export const serialzierSFL = ajv.compileSerializer(schema_SaveFile_Latest)
